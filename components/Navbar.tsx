...
const Navbar = () => {
    ...
    return (
        <>
            ...
            <div
                className={cn(
                    'fixed top-0 right-0 h-[100dvh] w-[500px] max-w-[calc(100vw-3rem)] transform translate-x-full transition-transform duration-700 z-[3] overflow-y-auto overflow-x-hidden gap-y-10',
