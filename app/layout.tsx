...
export const metadata: Metadata = {
    title: 'Nihal Patel — AI & Cloud Engineering',
    description:
        'Computer Science student focused on AI systems, cloud engineering, scalable software, and research-driven computing.',
};
